          ...
          {team.map((member, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative rounded-2xl overflow-hidden border border-gray-200 cursor-pointer"
              >
                ...
                >
                  ...
                  {/* Mobile hint */}
                  <span className="text-xs text-gray-500 mt-4 lg:hidden">
                    Tap again to close
                  </span>
                </div>
